...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Ki 2-2025\LTHD\task-management-AI\public\storage' => 'string',
...
'filesystems.links.D:\\Ki 2-2025\\LTHD\\task-management-AI\\public\\storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'services.gemini.key','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'view.compiled','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','projects.index','projects.create','projects.show','projects.edit',
'dashboard',);
...
'layouts.guest','livewire.dashbaord','livewire.project.create','livewire.project.edit','livewire.project.index',
'livewire.task.index','livewire.task.task-modal','navigation-menu','policy','profile.delete-user-form',
...
'projects.create','projects.edit','projects.index','projects.show','tasks.index',
